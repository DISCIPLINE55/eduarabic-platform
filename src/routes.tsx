...
import InviteLinksPage from './pages/super-admin/InviteLinksPage';
...
import GuestExplorePage from './pages/guest/GuestExplorePage';
import GuestEnrollPage from './pages/guest/GuestEnrollPage';
...
import HifzTutorPage from './pages/shared/HifzTutorPage';
...
export const routes: RouteConfig[] = [
  ...
  // Admin onboarding wizard (runs after first login when admin has no org)
  { name: 'Admin Onboarding', path: '/admin/onboarding', element: <AdminOnboardingPage /> },
  ...
  { name: 'Invite Links', path: '/super-admin/invite-links', element: <InviteLinksPage /> },
  { name: 'Platform Analytics', path: '/super-admin/analytics', element: <PlatformAnalyticsPage /> },
  { name: 'Audit Logs', path: '/super-admin/audit-logs', element: <AuditLogsPage /> },
  ...
  { name: 'Enrollment Requests', path: '/admin/enrollments', element: <EnrollmentRequestsPage /> },
  ...
  { name: 'AI Hifz Tutor', path: '/teacher/hifz-tutor', element: <HifzTutorPage /> },
  ...
  // Guest — Quran publicly accessible so guests can use the full Quran player
  { name: 'Guest Welcome', path: '/guest', element: <GuestDashboard /> },
  { name: 'Explore Institutions', path: '/guest/explore', element: <GuestExplorePage />, public: true },
  { name: 'Enroll in Institution', path: '/guest/enroll', element: <GuestEnrollPage /> },
  { name: 'Quran Viewer (Guest)', path: '/guest/quran', element: <QuranViewerPage />, public: true },
  ...
  { name: 'AI Hifz Tutor', path: '/student/hifz-tutor', element: <HifzTutorPage /> },
