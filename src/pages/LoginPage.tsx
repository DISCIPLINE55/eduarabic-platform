...
import { Loader2, BookOpen, Eye, EyeOff, Compass } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <DisciNetLogo size={56} variant="icon" theme="light" />
          </div>
          <DisciNetLogo size={32} variant="wordmark" theme="light" className="justify-center mb-1" />
          <p className="text-muted-foreground text-sm mt-1 text-pretty">Knowledge. Faith. Innovation.</p>
        </div>
          ...
          <TabsContent value="login">
            <Card className="max-w-[calc(100%-0rem)]">
              <CardHeader>
                ...
                <CardDescription>Sign in to your DisciNet account</CardDescription>
              </CardHeader>
          ...
          <TabsContent value="register">
            <Card className="max-w-[calc(100%-0rem)]">
              <CardHeader>
                ...
                <CardDescription>Join DisciNet as a new user. Contact your institution admin to assign your role.</CardDescription>
              </CardHeader>
        ...
        <p className="text-center text-xs text-muted-foreground mt-2 text-pretty">
          Browse institutions and preview features — no account required.
        </p>
